...
describe('Avancement Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'avancement', component: AvancementComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.avancements?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to avancementService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAvancementIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAvancementIdentifier).toHaveBeenCalledWith(entity);
