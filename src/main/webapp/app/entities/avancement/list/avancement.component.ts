...
import { EntityArrayResponseType, AvancementService } from '../service/avancement.service';
...
export class AvancementComponent implements OnInit {
  ...
  trackId = (_index: number, item: IAvancement): number => this.avancementService.getAvancementIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.avancements = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IAvancement[] | null): IAvancement[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.avancementService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
