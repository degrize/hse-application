...
!(function () {
  ...
  var $ = { x: 0, y: 0, width: '100%', height: '100%' },
    tt = function (t) {
      ...
      return (
        e.push(p, { tag: 'rect', attributes: E({ fill: 'currentColor', 'clip-path': 'url(#' + h + ')', mask: 'url(#' + g + ')' }, $) }),
  ...
  function nt(t) {
    ...
    u && (v.attributes[A] = ''),
      l && v.children.push({ tag: 'title', attributes: { id: v.attributes['aria-labelledby'] || 'title-' + q() }, children: [l] });
  ...
  var zt = {
    replace: function (t) {
      ...
      if (e.parentNode && e.outerHTML)
        e.outerHTML = r + (T.keepOriginalSource && 'svg' !== e.tagName.toLowerCase() ? '\x3c!-- ' + e.outerHTML + ' --\x3e' : '');
              ...
              Object.keys(n).forEach(function (t) {
                (e.definitions[t] = E({}, e.definitions[t] || {}, n[t])),
                  (function t(e, a) {
                    ...
                    'function' == typeof I.hooks.addPack ? I.hooks.addPack(e, r) : (I.styles[e] = E({}, I.styles[e] || {}, r)),
                      'fas' === e && t('fa', a);
                  })(t, n[t]),
                  vt();
              });
