package com.degrize.hseapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.degrize.hseapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.degrize.hseapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
